...
@Component(
		 ...
		 service = {org.adempiere.report.jasper.JRViewerProvider.class,org.adempiere.webui.window.ZkJRViewerProviderNtier.class}
		 )
public class ZkJRViewerProviderNtier implements JRViewerProvider, JRViewerProviderList {
	...
	public void openViewer(final JasperPrint jasperPrint, final String title, final PrintInfo printInfo)
		...
		Runnable runnable = new Runnable() {
			...
			@Override
			public void run() {
				Window viewer = new ZkJRViewerNtier(jasperPrint, title, printInfo);
	...
	public void openViewer(final List<JasperPrint> jasperPrintList, final String title , final PrintInfo printInfo)
		...
		Runnable runnable = new Runnable() {
			...
			@Override
			public void run() {
				Window viewer = new ZkJRViewerNtier(jasperPrintList, title, printInfo);
