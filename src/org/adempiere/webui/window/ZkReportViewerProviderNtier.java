 ...
 *
 */
//@Component(immediate = true, service = ReportViewerProvider.class, property = {"service.ranking:Integer=1"}) 
public class ZkReportViewerProviderNtier implements ReportViewerProvider {
	...
	protected void openReportViewWindow (ReportEngine report) {
		ZkReportViewerNtier viewer = new ZkReportViewerNtier(report, report.getName());
