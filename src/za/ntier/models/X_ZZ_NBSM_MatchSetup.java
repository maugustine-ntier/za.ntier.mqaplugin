...
@org.adempiere.base.Model(table="ZZ_NBSM_MatchSetup")
...
// @Description@
    ...
    /** Standard Constructor */
    public X_ZZ_NBSM_MatchSetup (Properties ctx, int ZZ_NBSM_MatchSetup_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_NBSM_MatchSetup_ID, trxName, virtualColumns);
      /** if (ZZ_NBSM_MatchSetup_ID == 0)
        {
			setC_BankAccount_ID (0);
// @C_BankAccount_ID@
...
// @Description@
    ...
    /** Standard Constructor */
    public X_ZZ_NBSM_MatchSetup (Properties ctx, String ZZ_NBSM_MatchSetup_UU, String trxName)
    {
      super (ctx, ZZ_NBSM_MatchSetup_UU, trxName);
      /** if (ZZ_NBSM_MatchSetup_UU == null)
        {
			setC_BankAccount_ID (0);
// @C_BankAccount_ID@
			setLine (0);
...
// @Description@
    ...
    /** Standard Constructor */
    public X_ZZ_NBSM_MatchSetup (Properties ctx, String ZZ_NBSM_MatchSetup_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_NBSM_MatchSetup_UU, trxName, virtualColumns);
      /** if (ZZ_NBSM_MatchSetup_UU == null)
        {
			setC_BankAccount_ID (0);
// @C_BankAccount_ID@
...
// @Description@
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_NBSM_MatchSetup[")
