...
// N
	...
	*/
	...
	/** Set Whatsapp Sent.
		@param ZZ_Whatsapp_Sent Whatsapp Sent
	*/
	public void setZZ_Whatsapp_Sent (boolean ZZ_Whatsapp_Sent)
	{
		set_Value (COLUMNNAME_ZZ_Whatsapp_Sent, Boolean.valueOf(ZZ_Whatsapp_Sent));
	}

	/** Get Whatsapp Sent.
		@return Whatsapp Sent	  */
	public boolean isZZ_Whatsapp_Sent()
	{
		Object oo = get_Value(COLUMNNAME_ZZ_Whatsapp_Sent);
		if (oo != null)
		{
			 if (oo instanceof Boolean)
				 return ((Boolean)oo).booleanValue();
