...
/** Generated Model for ZZ_System_Access_App
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_System_Access_App")
public class X_ZZ_System_Access_App extends PO implements I_ZZ_System_Access_App, I_Persistent
{
    ...
    public X_ZZ_System_Access_App (Properties ctx, int ZZ_System_Access_App_ID, String trxName)
    {
      super (ctx, ZZ_System_Access_App_ID, trxName);
      /** if (ZZ_System_Access_App_ID == 0)
        {
			setZZ_System_Access_App_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_System_Access_App (Properties ctx, int ZZ_System_Access_App_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_System_Access_App_ID, trxName, virtualColumns);
      /** if (ZZ_System_Access_App_ID == 0)
        {
			setZZ_System_Access_App_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_System_Access_App (Properties ctx, String ZZ_System_Access_App_UU, String trxName)
    {
      super (ctx, ZZ_System_Access_App_UU, trxName);
      /** if (ZZ_System_Access_App_UU == null)
        {
			setZZ_System_Access_App_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZ_System_Access_App (Properties ctx, String ZZ_System_Access_App_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_System_Access_App_UU, trxName, virtualColumns);
      /** if (ZZ_System_Access_App_UU == null)
        {
			setZZ_System_Access_App_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_ZZ_System_Access_App (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_System_Access_App[")
	...
	*/
	...
	/** Set System Access Application.
		@param ZZ_System_Access_App_ID System Access Application
	*/
	public void setZZ_System_Access_App_ID (int ZZ_System_Access_App_ID)
	{
		if (ZZ_System_Access_App_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_System_Access_App_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_System_Access_App_ID, Integer.valueOf(ZZ_System_Access_App_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_System_Access_App_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set ZZ_System_Access_App_UU.
		@param ZZ_System_Access_App_UU ZZ_System_Access_App_UU
	*/
	public void setZZ_System_Access_App_UU (String ZZ_System_Access_App_UU)
	{
		set_Value (COLUMNNAME_ZZ_System_Access_App_UU, ZZ_System_Access_App_UU);
	}

	/** Get ZZ_System_Access_App_UU.
		@return ZZ_System_Access_App_UU	  */
	public String getZZ_System_Access_App_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_System_Access_App_UU);
	}
}