...
/** Generated Model for ZZ_Petty_Cash_Claim_Hdr
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_Petty_Cash_Claim_Hdr")
public class X_ZZ_Petty_Cash_Claim_Hdr extends PO implements I_ZZ_Petty_Cash_Claim_Hdr, I_Persistent
{
    ...
    public X_ZZ_Petty_Cash_Claim_Hdr (Properties ctx, int ZZ_Petty_Cash_Claim_Hdr_ID, String trxName)
    {
      ...
      /** if (ZZ_Petty_Cash_Claim_Hdr_ID == 0)
        {
			setLine_Manager_ID (0);
			setZZ_Petty_Cash_Claim_Hdr_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_Petty_Cash_Claim_Hdr (Properties ctx, int ZZ_Petty_Cash_Claim_Hdr_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Standard Constructor */
    public X_ZZ_Petty_Cash_Claim_Hdr (Properties ctx, String ZZ_Petty_Cash_Claim_Hdr_UU, String trxName)
    {
      super (ctx, ZZ_Petty_Cash_Claim_Hdr_UU, trxName);
      /** if (ZZ_Petty_Cash_Claim_Hdr_UU == null)
        {
			setLine_Manager_ID (0);
			setZZ_Petty_Cash_Claim_Hdr_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_Petty_Cash_Claim_Hdr (Properties ctx, String ZZ_Petty_Cash_Claim_Hdr_UU, String trxName, String ... virtualColumns)
    {
    ...
    /** Load Constructor */
    public X_ZZ_Petty_Cash_Claim_Hdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_Petty_Cash_Claim_Hdr[")
	...
	*/
	...
	/** Set ZZ_Petty_Cash_Claim_Hdr_UU.
		@param ZZ_Petty_Cash_Claim_Hdr_UU ZZ_Petty_Cash_Claim_Hdr_UU
	*/
	public void setZZ_Petty_Cash_Claim_Hdr_UU (String ZZ_Petty_Cash_Claim_Hdr_UU)
	{
		set_Value (COLUMNNAME_ZZ_Petty_Cash_Claim_Hdr_UU, ZZ_Petty_Cash_Claim_Hdr_UU);
	}

	/** Get ZZ_Petty_Cash_Claim_Hdr_UU.
		@return ZZ_Petty_Cash_Claim_Hdr_UU	  */
	public String getZZ_Petty_Cash_Claim_Hdr_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_Petty_Cash_Claim_Hdr_UU);
	}
