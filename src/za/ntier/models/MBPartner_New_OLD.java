...
public class MBPartner_New_OLD extends MBPartner {
	...
	public MBPartner_New_OLD(Properties ctx) {
		super(ctx);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, ResultSet rs, String trxName) {
		super(ctx, rs, trxName);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, String C_BPartner_UU, String trxName) {
		super(ctx, C_BPartner_UU, trxName);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, int C_BPartner_ID, String trxName) {
		super(ctx, C_BPartner_ID, trxName);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(X_I_BPartner impBP) {
		super(impBP);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(MBPartner copy) {
		super(copy);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, MBPartner copy) {
		super(ctx, copy);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, MBPartner copy, String trxName) {
		super(ctx, copy, trxName);
		// TODO Auto-generated constructor stub
	}

	public MBPartner_New_OLD(Properties ctx, int C_BPartner_ID, String trxName, String... virtualColumns) {
	...
	private void validate() {
		...
		ResultSet rsRT = null;
		try {
			stmtRT = DB.prepareStatement(sqlRemoteTables, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
	...
	private void validateExternalTable(String tableName) {
		...
		ResultSet rsRC = null;
		try {
			stmtRC = DB.prepareStatement(sqlRemoteColumns, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
	...
	private void validateExternalColumn(String tableName, String columnName, int refID, int length) {
		...
		if (! Util.isEmpty(foreignTableName)) {
			...
			ResultSet rsFC = null;
			try {
				stmtFC = DB	.prepareStatement(sqlForeignClient, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
	...
	private int countInExternal(String sql) {
		...
		ResultSet rs = null;
		try {
			stmt = DB	.prepareStatement(sql, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
	...
	private void moveClient() {
		...
		for (MTable table : tables) {
			...
			ResultSet rsGI = null;
			try {
				stmtGI = DB.prepareStatement(selectGetIds, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
	...
	private String getExternalTableFromTree(int treeId) {
		...
		ResultSet rs = null;
		try {
			stmt = DB.prepareStatement(sqlTableTree, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY,get_TrxName());
