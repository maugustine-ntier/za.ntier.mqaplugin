...
public interface I_M_InOut 
{
    ...
    /** Column name ZZ_CreateLinesFrom */
    public static final String COLUMNNAME_ZZ_CreateLinesFrom = "ZZ_CreateLinesFrom";
    ...
    /** Column name ZZ_Mine_Ticket */
    public static final String COLUMNNAME_ZZ_Mine_Ticket = "ZZ_Mine_Ticket";
    ...
    /** Column name ZZ_Rom_Type */
    public static final String COLUMNNAME_ZZ_Rom_Type = "ZZ_Rom_Type";
    ...
    /** Column name ZZ_StockPile_Ref */
    public static final String COLUMNNAME_ZZ_StockPile_Ref = "ZZ_StockPile_Ref";
    ...
    /** Column name ZZ_Vehicle_Reg_No */
    public static final String COLUMNNAME_ZZ_Vehicle_Reg_No = "ZZ_Vehicle_Reg_No";
    ...
    /** Column name ZZ_Wet_Metric_Tons */
    public static final String COLUMNNAME_ZZ_Wet_Metric_Tons = "ZZ_Wet_Metric_Tons";
