...
/** Generated Model for T_TrialBalance_Ntier
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="T_TrialBalance_Ntier")
public class X_T_TrialBalance_Ntier extends PO implements I_T_TrialBalance_Ntier, I_Persistent
{
    ...
    public X_T_TrialBalance_Ntier (Properties ctx, String T_TrialBalance_Ntier_UU, String trxName)
    {
      super (ctx, T_TrialBalance_Ntier_UU, trxName);
      /** if (T_TrialBalance_Ntier_UU == null)
        {
    ...
    /** Standard Constructor */
    public X_T_TrialBalance_Ntier (Properties ctx, String T_TrialBalance_Ntier_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, T_TrialBalance_Ntier_UU, trxName, virtualColumns);
      /** if (T_TrialBalance_Ntier_UU == null)
        {
			setAD_PInstance_ID (0);
			setAmtAcctBalance (Env.ZERO);
    ...
    /** Load Constructor */
    public X_T_TrialBalance_Ntier (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_T_TrialBalance_Ntier[")
	...
	*/
	...
	/** Set T_TrialBalance_Ntier_UU.
		@param T_TrialBalance_Ntier_UU T_TrialBalance_Ntier_UU
	*/
	public void setT_TrialBalance_Ntier_UU (String T_TrialBalance_Ntier_UU)
	{
		set_Value (COLUMNNAME_T_TrialBalance_Ntier_UU, T_TrialBalance_Ntier_UU);
	}

	/** Get T_TrialBalance_Ntier_UU.
		@return T_TrialBalance_Ntier_UU	  */
	public String getT_TrialBalance_Ntier_UU()
	{
		return (String)get_Value(COLUMNNAME_T_TrialBalance_Ntier_UU);
	}
	...
	*/
	...
	/** Set Account Description.
		@param ZZ_Account_Description Account Description
	*/
	public void setZZ_Account_Description (String ZZ_Account_Description)
	{
		set_Value (COLUMNNAME_ZZ_Account_Description, ZZ_Account_Description);
	}

	/** Get Account Description.
		@return Account Description	  */
	public String getZZ_Account_Description()
	{
		return (String)get_Value(COLUMNNAME_ZZ_Account_Description);
	}

	/** Set Budget YTD.
		@param ZZ_Budget_YTD Budget YTD
	*/
	public void setZZ_Budget_YTD (BigDecimal ZZ_Budget_YTD)
	{
		set_Value (COLUMNNAME_ZZ_Budget_YTD, ZZ_Budget_YTD);
	}

	/** Get Budget YTD.
		@return Budget YTD	  */
	public BigDecimal getZZ_Budget_YTD()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ZZ_Budget_YTD);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Prior Year Full.
		@param ZZ_Prior_Year_Full Prior Year Full
	*/
	public void setZZ_Prior_Year_Full (BigDecimal ZZ_Prior_Year_Full)
	{
		set_Value (COLUMNNAME_ZZ_Prior_Year_Full, ZZ_Prior_Year_Full);
	}

	/** Get Prior Year Full.
		@return Prior Year Full	  */
	public BigDecimal getZZ_Prior_Year_Full()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ZZ_Prior_Year_Full);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Total Budget.
		@param ZZ_Total_Budget Total Budget
	*/
	public void setZZ_Total_Budget (BigDecimal ZZ_Total_Budget)
	{
		set_Value (COLUMNNAME_ZZ_Total_Budget, ZZ_Total_Budget);
	}

	/** Get Total Budget.
		@return Total Budget	  */
	public BigDecimal getZZ_Total_Budget()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ZZ_Total_Budget);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set YTD Current.
		@param ZZ_YTD_Current YTD Current
	*/
	public void setZZ_YTD_Current (BigDecimal ZZ_YTD_Current)
	{
		set_Value (COLUMNNAME_ZZ_YTD_Current, ZZ_YTD_Current);
	}

	/** Get YTD Current.
		@return YTD Current	  */
	public BigDecimal getZZ_YTD_Current()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ZZ_YTD_Current);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set YTD Prior.
		@param ZZ_YTD_Prior YTD Prior
	*/
	public void setZZ_YTD_Prior (BigDecimal ZZ_YTD_Prior)
	{
		set_Value (COLUMNNAME_ZZ_YTD_Prior, ZZ_YTD_Prior);
	}

	/** Get YTD Prior.
		@return YTD Prior	  */
	public BigDecimal getZZ_YTD_Prior()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ZZ_YTD_Prior);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
