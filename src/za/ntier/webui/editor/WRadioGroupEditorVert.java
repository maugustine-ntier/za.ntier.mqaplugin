...
import org.adempiere.webui.editor.WRadioGroupEditor.RadioGroupEditor;
 ...
 *
 */
public class WRadioGroupEditorVert extends WEditor implements ContextMenuListener, ListDataListener, IZoomableEditor
{
    ...
    static
    {
        logger = CLogger.getCLogger(WRadioGroupEditorVert.class);
    }
	 ...
	 * @param gridField
	 */
	public WRadioGroupEditorVert(GridField gridField)
	{
	 ...
	 */
    public WRadioGroupEditorVert(GridField gridField, boolean tableEditor, IEditorConfiguration editorConfiguration)
    {
        super(new RadioGroupEditorVert(), gridField, tableEditor, editorConfiguration);
	 ...
	 */   
    public WRadioGroupEditorVert(Lookup lookup, String label, String description, boolean mandatory, boolean readonly, boolean updateable)
	{
		super(new RadioGroupEditorVert(), label, description, mandatory, readonly, updateable);
		if (lookup == null)
		{
     ...
     * @param lookup
     */
    public WRadioGroupEditorVert(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
    		Lookup lookup)
    {
    	super(new RadioGroupEditorVert(), columnName, null, null, mandatory, isReadOnly, isUpdateable);
    	if (lookup == null)
		{
			throw new IllegalArgumentException("Lookup cannot be null");
		}
    ...
    @Override
	public RadioGroupEditorVert getComponent() {
		return (RadioGroupEditorVert) component;
	}
	 ...
	 */
	public static class RadioGroupEditorVert extends Vlayout {  // Martin changed to VLayout
		/**
		 * generated serial id
		 */
