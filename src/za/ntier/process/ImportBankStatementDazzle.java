...
public class ImportBankStatementDazzle extends SvrProcess
{
	...
	protected String doIt() throws java.lang.Exception
	{
		...
		sql = new StringBuilder("SELECT * FROM I_BankStatement")
			...
			.append(" ORDER BY I_BankStatement_ID,C_BankAccount_ID, Name, EftStatementDate, EftStatementReference");  // Martin added
		                                                                                                    // I_BankStatement_ID
