 ...
 */
public final class MLocationLookup_New extends Lookup
	implements Serializable
{
	 ...
	 */
	public MLocationLookup_New(Properties ctx, int WindowNo)
	{
	...
	public String getDisplay (Object key)
	{
		...
		MLocation_New loc = getLocation (key, null);
		if (loc == null){
	 ...
	 */
	public MLocation_New getLocation (Object key, String trxName)
	{
		if (key == null) {
			return null;
		}
	 ...
	 * 	@return Location
	 */
	public MLocation_New getLocation (int C_Location_ID, String trxName)
	{
		return MLocation_New.getCopy(m_ctx, C_Location_ID, trxName);
	}	//	getC_Location_ID
