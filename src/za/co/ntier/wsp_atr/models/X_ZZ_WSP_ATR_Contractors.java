...
/** Generated Model for ZZ_WSP_ATR_Contractors
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_WSP_ATR_Contractors")
public class X_ZZ_WSP_ATR_Contractors extends PO implements I_ZZ_WSP_ATR_Contractors, I_Persistent
{
    ...
    public X_ZZ_WSP_ATR_Contractors (Properties ctx, int ZZ_WSP_ATR_Contractors_ID, String trxName)
    {
      super (ctx, ZZ_WSP_ATR_Contractors_ID, trxName);
      /** if (ZZ_WSP_ATR_Contractors_ID == 0)
        {
			setZZ_Clerical_Planned (0);
			setZZ_Clerical_Trained (0);
			setZZ_Elementary_Planned (0);
			setZZ_Elementary_Trained (0);
			setZZ_Learners_Planned (0);
			setZZ_Learners_Trained (0);
			setZZ_Learning_Programme_ID (0);
			setZZ_Learning_Programme_Type_ID (0);
			setZZ_Managers_Planned (0);
			setZZ_Managers_Trained (0);
			setZZ_Plant_Planned (0);
			setZZ_Plant_Trained (0);
			setZZ_Professionals_Planned (0);
			setZZ_Professionals_Trained (0);
			setZZ_Service_Planned (0);
			setZZ_Service_Trained (0);
			setZZ_Skilled_Workers_Planned (0);
			setZZ_Skilled_Workers_Trained (0);
			setZZ_Technicians_Planned (0);
			setZZ_Technicians_Trained (0);
			setZZ_Total_Trained (0);
			setZZ_WSP_ATR_Contractors_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Contractors (Properties ctx, int ZZ_WSP_ATR_Contractors_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WSP_ATR_Contractors_ID, trxName, virtualColumns);
      /** if (ZZ_WSP_ATR_Contractors_ID == 0)
        {
			setZZ_Clerical_Planned (0);
			setZZ_Clerical_Trained (0);
    ...
    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Contractors (Properties ctx, String ZZ_WSP_ATR_Contractors_UU, String trxName)
    {
      super (ctx, ZZ_WSP_ATR_Contractors_UU, trxName);
      /** if (ZZ_WSP_ATR_Contractors_UU == null)
        {
			setZZ_Clerical_Planned (0);
			setZZ_Clerical_Trained (0);
			setZZ_Elementary_Planned (0);
    ...
    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Contractors (Properties ctx, String ZZ_WSP_ATR_Contractors_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WSP_ATR_Contractors_UU, trxName, virtualColumns);
      /** if (ZZ_WSP_ATR_Contractors_UU == null)
        {
			setZZ_Clerical_Planned (0);
			setZZ_Clerical_Trained (0);
    ...
    /** Load Constructor */
    public X_ZZ_WSP_ATR_Contractors (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_WSP_ATR_Contractors[")
	...
	*/
	...
	public I_ZZ_Contractors_Learning_Programme_Ref getZZ_Learning_Programme() throws RuntimeException
	{
	...
	*/
	...
	public I_ZZ_Qualification_Type_Details_Ref getZZ_Learning_Programme_Type() throws RuntimeException
	{
	...
	*/
	...
	/** Set ZZ WSP ATR Contractors.
		@param ZZ_WSP_ATR_Contractors_ID ZZ WSP ATR Contractors
	*/
	public void setZZ_WSP_ATR_Contractors_ID (int ZZ_WSP_ATR_Contractors_ID)
	{
		if (ZZ_WSP_ATR_Contractors_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_WSP_ATR_Contractors_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_WSP_ATR_Contractors_ID, Integer.valueOf(ZZ_WSP_ATR_Contractors_ID));
	}

	/** Get ZZ WSP ATR Contractors.
		@return ZZ WSP ATR Contractors	  */
	public int getZZ_WSP_ATR_Contractors_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_WSP_ATR_Contractors_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set ZZ_WSP_ATR_Contractors_UU.
		@param ZZ_WSP_ATR_Contractors_UU ZZ_WSP_ATR_Contractors_UU
	*/
	public void setZZ_WSP_ATR_Contractors_UU (String ZZ_WSP_ATR_Contractors_UU)
	{
		set_Value (COLUMNNAME_ZZ_WSP_ATR_Contractors_UU, ZZ_WSP_ATR_Contractors_UU);
	}

	/** Get ZZ_WSP_ATR_Contractors_UU.
		@return ZZ_WSP_ATR_Contractors_UU	  */
	public String getZZ_WSP_ATR_Contractors_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_WSP_ATR_Contractors_UU);
	}
